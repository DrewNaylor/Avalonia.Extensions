...
{
    public class ItemsView : TemplatedControl, IItemsPresenterHost, ICollectionChangedListener, IStyling
    {
        /// <summary>
        ...
        /// </summary>
        public static readonly DirectProperty<ItemsView, IEnumerable<ExpandableObject>> ItemsProperty =
            AvaloniaProperty.RegisterDirect<ItemsView, IEnumerable<ExpandableObject>>(nameof(Items), o => o.Items, (o, v) => o.Items = v);
        /// <summary>
        /// Defines the <see cref="ItemCount"/> property.
        /// </summary>
        public static readonly DirectProperty<ItemsView, int> ItemCountProperty =
            AvaloniaProperty.RegisterDirect<ItemsView, int>(nameof(ItemCount), o => o.ItemCount);
        /// <summary>
        /// Defines the <see cref="ItemsPanel"/> property.
        /// </summary>
        public static readonly StyledProperty<ITemplate<IPanel>> ItemsPanelProperty =
            AvaloniaProperty.Register<ItemsView, ITemplate<IPanel>>(nameof(ItemsPanel), DefaultPanel);
        /// <summary>
        /// Defines the <see cref="ItemTemplate"/> property.
        /// </summary>
        public static readonly StyledProperty<IDataTemplate> ItemTemplateProperty =
            AvaloniaProperty.Register<ItemsView, IDataTemplate>(nameof(ItemTemplate));
        private int _itemCount;
        private IEnumerable<ExpandableObject> _items = new AvaloniaList<ExpandableObject>();
        private IItemContainerGenerator _itemContainerGenerator;
        /// <summary>
        /// Initializes static members of the <see cref="ItemsView"/> class.
        /// </summary>
        static ItemsView()
        {
            ItemsProperty.Changed.AddClassHandler<ItemsView>((x, e) => x.ItemsChanged(e));
            ItemTemplateProperty.Changed.AddClassHandler<ItemsView>((x, e) => x.ItemTemplateChanged(e));
        }
        /// <summary>
        ...
        /// </summary>
        [Content]
        public IEnumerable<ExpandableObject> Items
        {
            get => _items;
        ...
        /// containers; however they want it to be ItemsViews so that they have an Items 
        ...
        /// <summary>
        /// Called when new containers are materialized for the <see cref="ItemsView"/> by its
        ...
        /// <summary>
        /// Called when containers are dematerialized for the <see cref="ItemsView"/> by its
        /// <see cref="ItemContainerGenerator"/>.
        /// </summary>
        /// <param name="e">The details of the containers.</param>
        ...
        /// <summary>
        /// Called when containers are recycled for the <see cref="ItemsView"/> by its
        /// <see cref="ItemContainerGenerator"/>.
        /// </summary>
        /// <param name="e">The details of the containers.</param>
        protected virtual void OnContainersRecycled(ItemContainerEventArgs e) { }
        /// <summary>
        /// Handles directional navigation within the <see cref="ItemsView"/>.
        /// </summary>
        ...
        protected override void OnKeyDown(KeyEventArgs e)
        {
            if (!e.Handled)
            {
                ...
                if (Presenter?.Panel is not INavigableContainer container || focus.Current == null || direction == null || direction.Value.IsTab())
                    return;
