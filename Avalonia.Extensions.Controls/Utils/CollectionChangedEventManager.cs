...
namespace Avalonia.Extensions.Controls.Utils
{
    internal class CollectionChangedEventManager
    {
        ...
        private readonly ConditionalWeakTable<INotifyCollectionChanged, Entry> _entries =
        ...
        private class Entry : IWeakSubscriber<NotifyCollectionChangedEventArgs>, IDisposable
        {
            ...
            public Entry(INotifyCollectionChanged collection)
            {
                ...
                WeakSubscriptionManager.Subscribe(_collection, nameof(INotifyCollectionChanged.CollectionChanged), this);
            }
            public List<WeakReference<ICollectionChangedListener>> Listeners { get; }
            public void Dispose()
            {
                WeakSubscriptionManager.Unsubscribe(_collection, nameof(INotifyCollectionChanged.CollectionChanged), this);
            }
            void IWeakSubscriber<NotifyCollectionChangedEventArgs>.OnEvent(object sender, NotifyCollectionChangedEventArgs e)
            {
                static void Notify(INotifyCollectionChanged incc, NotifyCollectionChangedEventArgs args, List<WeakReference<ICollectionChangedListener>> listeners)
                {
